...
<div class="my-center-container">
    ...
    <div style="width:500px" class="block p-6 rounded-lg shadow-lg bg-white max-w-sm">
        <form action="userLogin" method="POST">
            @csrf
      <div class="form-group mb-6">
        <label for="exampleInputEmail2" class="form-label inline-block mb-2 text-gray-700">Email address</label>
        <input type="email" name="email" value="jainilsoni@gmail.com" class="form-control
        block
        w-full
        px-3
        py-1.5
    ...
    <div class="form-group mb-6">
        ...
        <input type="password" name="password" value="12345" class="form-control block
        w-full
        px-3
        py-1.5
        text-base
        ...
        @else 
        <div class="alert alert-danger" style="display:none!important;"></div>
        @endif
        <div style="float: right!important" class="flex justify-between items-center mb-6">
            <a href="#!"
        ...
        <p class="text-gray-800 mt-6 text-center">Not a member? <a href="{{url('register')}}"
